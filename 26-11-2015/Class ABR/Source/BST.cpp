...
template< typename  Filler >
void BST < Filler > :: ElimCasoTre ( NODO < Filler > * Nodo ){
    NODO < Filler > * Succ;

    Succ = this->Successore ( Nodo->GetRight (), Nodo->GetElem () );
    Nodo->SetElem ( Succ->GetElem () );
    this->EliminaElemento ( Succ, Succ->GetElem () );
}
